...
public class Blog {
	...
	private boolean appreciation; //打賞
	
	private boolean shareStatement;//分享
	
	private boolean commentabled; //評論
	...
	public void init() {
		System.out.println(tagToIds(this.getTags()));
	...
	public String toString() {
		return "Blog [id=" + id + ", title=" + title + ", content=" + content + ", firstPicture=" + firstPicture
				...
				+ recommend + ", createTime=" + createTime + ", updateTime=" + updateTime + ", type=" + type + ", tags="
				+ tags + ", user=" + user + ", comments=" + comments + ", tagIds=" + tagIds + ", description="
				+ description + "]";
	}
